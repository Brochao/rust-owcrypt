...
mod tests {
    ...
    extern {
        ...
        fn ECC_genPubkey(private_key: libc::uintptr_t,public_key:libc::uintptr_t, type_choose: libc::c_uint) -> libc::c_ushort;
    }
    ...
    fn example() {
        ...
        unsafe {
            ECC_genPubkey(private_key.as_ptr() as usize, public_key.as_ptr() as usize, 0xECC00000);
        }
...
mod sign_tests {
    ...
    fn example() {
        ...
        let id:[u8; 0] = [];
        let signature_result = ecc_set::signature(&private_key, &id, &message, consts::ECC_CURVE_SECP256K1);
